...
public class PianoGamebridge : MonoBehaviour
{
    ...
    public List<(float time, int index, int noteType, float holdDuration)> noteTimings = new List<(float, int, int, float)>
    {
        ...
        (0.1f, 7, 4, 1f), (1.2f, 7, 3, 0.5f), (1.9f, 5, 3, 0.5f), (2.6f, 4, 3, 0.5f),
        (3.3f, 5, 3, 0.5f), (4.0f, 7, 4, 1.0f),

        (5.1f, 2, 3, 0.5f), (5.8f, 4, 3, 0.5f), (6.5f, 5, 4, 1f),

        (7.6f, 4, 3, 0.5f),(8.3f, 5, 3, 0.5f), (9f, 7, 4, 1.0f),

        // London Bridge is falling down
        (10.1f, 7, 4, 1f), (11.2f, 7, 3, 0.5f), (11.9f, 5, 3, 0.5f), (12.6f, 4, 3, 0.5f),
        (13.3f, 5, 3, 0.5f), (14.0f, 7, 4, 1.0f),

        // My fair lady
        (15.1f, 2, 4, 1f), (16.2f, 7, 4, 1f), (17.3f, 4, 3, 0.5f), (18f, 0, 4, 1.0f),
    };
    ...
    void Update()
    {
        ...
        {
            if (!PianGameLog.gamebridge_isclear)
            {
                PianGameLog.clearcount += 1;
            }

            PianGameLog.gamebridge_isclear = true;
